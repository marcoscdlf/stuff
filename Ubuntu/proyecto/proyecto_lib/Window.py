...
import logging
logger = logging.getLogger('proyecto_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by ProyectoWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('ProyectoWindow')
        new_object = builder.get_object("proyecto_window")
    ...
    def finish_initializing(self, builder):
        ...
        self.settings = Gio.Settings("net.launchpad.proyecto")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('proyecto')
        except ImportError:
            pass
        ...
        try:
            from proyecto import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for proyecto."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for proyecto."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the ProyectoWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the ProyectoWindow is closed."""
